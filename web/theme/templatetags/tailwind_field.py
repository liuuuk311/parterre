...
from theme.tailwind import CSSContainer
...
class CrispyTailwindFieldNode(template.Node):
    base_input = (
        "block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-lg "
        "dark:bg-slate-700 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 "
        "focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring placeholder-gray-400/70"
    )

    date_input = (
        "inline pl-4 pr-8 py-2 mt-2 mr-2 text-gray-700 bg-white border border-gray-200 rounded-lg "
        "dark:bg-slate-700 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 "
        "focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring placeholder-gray-400/70"
    )
